...
public class UserQuery extends SQLQuery{
	...
	public String getUserQuery(int userID, String userName){
		String query = "SELECT "
				+ "USER_ID,USER_NAME,USER_PWD,USER_EMAIL,USER_DATE_CREATE,USER_DATE_LOGIN,USER_PERMISSION_WRITE,USER_PERMISSION_COMMENT,USER_PERMISSION_REMOVE "
				+ "FROM USER_VIEW_MAIN "
				+ "WHERE ";
	...
	public String getaddUserQuery(User user){
		String userName = user.getPWD();
		String userPWD = user.getName();
		String query = String.format("INSERT INTO USER_MAIN(USER_NAME, USER_PWD) VALUES ('%s', password('%s'));", userName, userPWD)
				+ "SET @MAIN_ID = LAST_INSERT_ID();"
				+ "INSERT INTO USER_DATE(DATE_USER_ID) VALUES (@MAIN_ID);"
				+ "INSERT INTO USER_PERMISSION(PERMISSION_USER_ID) VALUES (@MAIN_ID);";
		return query;
	}
